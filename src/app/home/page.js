        ...
        <div className="px-6 mx-auto max-w-screen-2xl lg:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            {[
              ...
              { href: "#", color: "text-red-500", label: "Configurações", description: "Ajustar preferências do sistema.", icon: "M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2Zm5 11h-4v4a1 1 0 0 1-2 0v-4H7a1 1 0 0 1 0-2h4V7a1 1 0 0 1 2 0v4h4a1 1 0 0 1 0 2Z" },
              { href: "#", color: "text-purple-500", label: "Parâmetros", description: "Ajustar parâmetros do sistema.", icon: "M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2Zm5 11h-4v4a1 1 0 0 1-2 0v-4H7a1 1 0 0 1 0-2h4V7a1 1 0 1 1 2 0v4h4a1 1 0 0 1 0 2Z" },
